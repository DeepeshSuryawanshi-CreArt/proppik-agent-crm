@extends('admin.layouts.vertical', ['title' => 'Edit Role', 'subTitle' => 'System'])
        ...
        <div class="card panel-card border-primary border-top" data-panel-card>
            <div class="card-header d-flex justify-content-between align-items-start flex-wrap gap-2">
                <div>
                    ...
                    <p class="text-muted mb-0">Modify the role information and adjust permissions</p>
                </div>
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.roles.update', $role) }}" class="needs-validation" novalidate>
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const collapses = document.querySelectorAll('.permission-group .collapse');
