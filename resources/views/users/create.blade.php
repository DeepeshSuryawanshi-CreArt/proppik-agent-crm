<x-app-layout>
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="h2 fw-bold mb-0">Create New User</h2>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control @error('country_code') is-invalid @enderror" 
                                       id="country_code" name="country_code" value="{{ old('country_code') }}" placeholder="IN">
                                @error('country_code')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control @error('dial_code') is-invalid @enderror" 
                                       id="dial_code" name="dial_code" value="{{ old('dial_code') }}" placeholder="+91">
                                @error('dial_code')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <select class="form-select @error('package') is-invalid @enderror" 
                                    ...
                                    <option value="Starter" @selected(old('package') == 'Starter')>Starter</option>
                                    <option value="Standard" @selected(old('package') == 'Standard')>Standard</option>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select @error('payment_type') is-invalid @enderror" 
                                    ...
                                    <option value="online_transfer" @selected(old('payment_type') == 'online_transfer')>Online Transfer</option>
                                    <option value="bank_transfer" @selected(old('payment_type') == 'bank_transfer')>Bank Transfer</option>
                                </select>
                                @error('payment_type')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
