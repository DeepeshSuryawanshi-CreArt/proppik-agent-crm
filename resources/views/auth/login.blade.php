            ...
            <div class="card-body px-3 py-5">
                <div class="mx-auto mb-4 text-center auth-logo">
                    <a href="##" class="logo-dark">
                        <img src="{{ asset('assets/logo/logo.svg') }}" height="75" alt="logo dark">
                    </a>

                    <a href="/" class="logo-light">
                        <img src="{{ asset('assets/logo/w-logo.svg') }}" height="75" alt="logo light">
                    </a>
                </div>
                ...
                <div class="px-4">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="authentication-form" id="loginForm" novalidate data-otp-send="#
                    " data-otp-verify="#" data-email-otp-send="#" data-email-otp-verify="">
